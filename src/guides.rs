...
pub static SPARROW_WALLET: WalletDef = WalletDef {
    ...
    downloads: &[DownloadLink {
        ...
        logo: "/logos/download_sparrow.png",
...
pub static INTERMEDIATE_LEVEL: GuideLevelDef = GuideLevelDef {
    ...
    intro: "Time to take your privacy and security to the next level. Your keys move off a general-purpose computer and onto a dedicated signing device, and you stop asking a stranger's server what your balance is. This level comes in two parts: set up a hardware wallet with Sparrow, then run your own Bitcoin node.",
    platforms: &["desktop"],
    wallets: &[],
    faq_dir: None,
    products: &[],
        ...
        GuideStep {
            ...
            products: &[
                ProductLink {
                    ...
                    logo: "/logos/coldcard-logo-nav.png",
        ...
        GuideStep {
            ...
            products: &[
                ProductLink {
                    ...
                    logo: "/logos/start9_transparent_inverted.png",
                ...
                ProductLink {
                    ...
                    logo: "/logos/raspiblitz_logo_main.png",
...
pub static ADVANCED_LEVEL: GuideLevelDef = GuideLevelDef {
    ...
    quote: "",
    quote_author: "",
    intro: "This tier is for bitcoin you cannot afford to lose. Your keys get spread across three signing devices, so no single device, location or mistake can take your stack with it. Simplicity still matters here: complexity is how people lose coins, so the setup goes no further than that goal requires. Three parts: build the multisig, learn to spend from it, then optional hardening.",
    platforms: &["desktop"],
    wallets: &[],
