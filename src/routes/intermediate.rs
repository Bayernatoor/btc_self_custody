    ...
    view! {
        ...
        >
            ...
            <div class="flex flex-col mx-auto px-4 pt-10 lg:pt-0">
                <h1 class="text-center text-[2.25rem] text-[#f7931a] font-semibold leading-tight md:text-[2.5rem] lg:text-[3rem]">
                    {title}
                </h1>
            ...
            <div class="px-4 lg:pt-0 lg:px-0">
                <h2 class="text-left text-[1.5rem] text-[#f7931a] font-semibold lg:text-[1.5rem]">
                    "Coldcard & Node Setup:"
                </h2>
            ...
            <div class="px-4 lg:pb-4 lg:px-0">
                ...
                <div class="pb-6 pt-4">
                    <GenericButton
                        path="/guides/intermediate/hardware-wallet".to_string()
                        wallet_title="Level up to Intermediate".to_string()
                        img_url="./../../../increase.png".to_string()
                        img_alt="Arrow icon created by Pixel perfect".to_string()
                    />
                </div>
            </div>
        </div>
...
// Renders the Hardware page of the intermediate guide.
#[component]
#[allow(non_snake_case)]
pub fn IntermediateHardwarePage() -> impl IntoView {
    ...
    view! {
        ...
        >
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex justify-center">
                        <GenericExternalButton
                            ...
                            wallet_title="Buy a ColdCard".to_string()
                            img_url="./../../../coldcard-logo-nav.png".to_string()
                            img_alt="coldcard logo".to_string()
                            new_width="24".to_string()
                            new_height="8".to_string()
                        />
                    </div>
                    <div class="flex justify-center">
                        <GenericExternalButton
                            path="https://store.coinkite.com/store/seedplate".to_string()
                            wallet_title="Buy a Seedplate".to_string()
                            img_url="./../../../steel.png".to_string()
                            img_alt="Steel plate".to_string()
                            new_width="10".to_string()
                            new_height="8".to_string()
                        />
                    </div>
                    <div class="flex justify-center">
                        <GenericExternalButton
                            path="https://store.coinkite.com/store/drillpunch".to_string()
                            wallet_title="Buy a Center Punch".to_string()
                            img_url="./../../../hole-puncher.png".to_string()
                            img_alt="Hole puncher icons created by Smashicons - Flaticon"
                                .to_string()
                            new_width="10".to_string()
                            new_height="8".to_string()
                        />
            ...
            <div class="px-4 lg:pb-4 lg:px-0">
                <hr class="border border-solid border-gray-400 mx-auto w-full mb-6"/>
                <h2 class="text-center pb-4 text-[1.5rem] text-[#f7931a] font-semibold lg:text-[1.5rem]">
                    "Start Here"
                </h2>
            ...
            <div class="px-4 lg:pb-4 lg:px-0">
                <h3 class="text-center pb-4 text-[1.5rem] text-[#f7931a] font-semibold lg:text-[1.5rem]">
                    "Step 2 - Node Setup"
                </h3>
                <div class="pb-4 flex justify-center">
                    <GenericButton
                        path="/guides/intermediate/node".to_string()
                        wallet_title="Running Bitcoin".to_string()
                        img_url="./../../../bitcoin_server.png".to_string()
                        img_alt="Arrow icon created by Pixel perfect".to_string()
                    />
                </div>
            </div>
...
/// Renders the Node page of the intermediate guide
#[component]
#[allow(non_snake_case)]
pub fn IntermediateNodePage() -> impl IntoView {
    ...
    view! {
        ...
        >
                ...
                <div class="flex flex-col md:flex-row justify-center gap-4">
                    ...
                    <div class="flex justify-center md:justify-end">
                        <GenericExternalButton
                            ...
                            wallet_title="Sovereign Computing".to_string()
                            img_url="./../../../start9_transparent_inverted.png".to_string()
                            img_alt="Start9 logo".to_string()
                            new_width="28".to_string()
                        />
                    </div>
                    <div class="flex justify-center md:justify-end">
                        <GenericExternalButton
                            path="https://mynodebtc.github.io/".to_string()
                            wallet_title="Bitcoin, Lightning and more!".to_string()
                            img_url="./../../../mynode_logo.png".to_string()
                            img_alt="MyNode logo".to_string()
                            new_width="30".to_string()
                        />
                    </div>
                    <div class="flex justify-center md:justify-start">
                        <GenericExternalButton
                            path="https://shop.fulmo.org/raspiblitz/".to_string()
                            wallet_title="Not Your Node, Not your Rules".to_string()
                            img_url="./../../../raspiblitz_logo_main.png".to_string()
                            img_alt="RaspiBlitz logo".to_string()
                            new_width="28".to_string()
                        />
                    </div>
                </div>
            ...
            <div class="px-4 lg:pb-4 lg:px-0">
                <hr class="border border-solid border-gray-400 mx-auto w-full mb-6"/>
                <h2 class="text-center pb-4 text-[1.5rem] text-[#f7931a] font-semibold">
                    "Start Here"
                </h2>
