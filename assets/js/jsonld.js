...
{"@type":"WebApplication","name":"The Bitcoin Observatory","url":"https://www.wehodlbtc.com/observatory","applicationCategory":"FinanceApplication","operatingSystem":"Web","description":"Live Bitcoin blockchain analytics dashboard with 30+ charts covering real-time network stats, fee analysis, mining pool distribution, embedded data tracking (OP_RETURN, Ordinals, Runes), and BIP signaling. Data sourced directly from a full Bitcoin Core node.","featureList":["Live blockchain dashboard with block height, difficulty, hashrate, mempool, and price","Network charts: block size, weight utilization, transaction count, block intervals, chain size","Adoption metrics: SegWit percentage, Taproot outputs, witness version comparison, address type evolution, key-path vs script-path spend tracking","Transaction metrics: RBF adoption, UTXO flow, transaction batching trends","Fee analysis: total fees per block in BTC/sats, block subsidy vs fee revenue breakdown","Mining analytics: difficulty history, mining pool dominance with OCEAN template miner identification, empty block tracking","Embedded data: OP_RETURN protocols (Runes, Omni Layer, Counterparty), Ordinals inscriptions, BRC-20 tokens, Stamps","BIP signaling tracker: BIP-110 version bit 4, BIP-54 coinbase locktime compliance per 2,016-block period","Halving countdown with measured block-time estimate","Difficulty adjustment predictor with expected change percentage","Chart overlays: halvings, BIP activations, Bitcoin Core releases, historical events, USD price, chain size","Time ranges from 1 day to full chain history with per-block and daily aggregation"],"offers":{"@type":"Offer","price":"0","priceCurrency":"USD"},"provider":{"@type":"Organization","name":"WE HODL BTC","url":"https://www.wehodlbtc.com"}},
