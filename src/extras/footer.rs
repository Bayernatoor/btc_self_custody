            ...
            <div class="my-6 lg:my-0">
                <div class="flex flex-row justify-center space-x-2 lg:justify-end">
                    ...
                    <a
                      ...
                      type="button"
                      class="rounded-full bg-[#333333] p-3 uppercase leading-normal text-white transition duration-150 ease-in-out hover:text-orange-400 focus:shadow-dark-1 focus:outline-none focus:ring-0 active:shadow-1"
                    ...
                    <a
                      ...
                      type="button"
                      class="rounded-full bg-[#333333] p-3 uppercase leading-normal text-white transition duration-150 ease-in-out hover:shadow-dark-1 focus:shadow-dark-1 focus:outline-none focus:ring-0 active:shadow-1"
                      data-twe-ripple-init
                      data-twe-ripple-color="light">
                      <span class="mx-auto [&>svg]:h-10 [&>svg]:w-10">
                        <svg
