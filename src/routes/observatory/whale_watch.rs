    ...
    view! {
        ...
        <div class="relative rounded-2xl overflow-hidden mb-5">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-end pb-3 sm:pb-4">
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-title text-white mb-1 drop-shadow-lg">"The Lookout"</h1>
                <p class="text-xs sm:text-sm lg:text-base text-white/60 max-w-xl mx-auto px-4 text-center drop-shadow">"Notable transactions spotted in real-time"</p>
            </div>
        </div>
