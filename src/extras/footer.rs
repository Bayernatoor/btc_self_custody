            ...
            <div class="max-w-4xl mx-auto px-6 py-6 lg:px-8">
                <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                    ...
                    <div class="lg:max-w-sm">
                        <div class="text-sm font-semibold text-white uppercase tracking-wide">"WE HODL BTC"</div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a
                            ...
                            class="p-2 rounded-lg text-white/40 hover:text-[#f7931a] hover:bg-white/5 transition-all duration-200"
                            aria-label="GitHub"
                        >
                ...
                <div class="mt-5 pt-4 border-t border-white/5 text-center">
                    <span class="text-[0.7rem] text-white/30">
                        "2026 · "
                        <a
