    ...
    view! {
        ...
        >
            ...
            <div class="space-y-10">
                ...
                <ChartCard title="Block Interval" description=chart_desc(range, "Minutes between consecutive blocks. Target is 10 minutes", "Each day's 1,440 minutes divided by the blocks it produced. Target is 10 minutes") chart_id="chart-interval" option=interval_option/>
                ...
                <ChartCard title="Adoption Velocity" description=chart_desc(range, "Change in each output type's share of outputs, in percentage points: a 144-block average against the same average 144 blocks earlier", "Change in each output type's share of outputs, in percentage points: a 30-day average against the same average 30 days earlier") chart_id="chart-multi-velocity" option=multi_velocity_option/>
                <ChartCard title="P2PKH Sunset Tracker" description=chart_desc(range, "Share of outputs paying the legacy '1...' address type, with reference lines at 10% and 5%", "Share of outputs paying the legacy '1...' address type, with a 90-day average and reference lines at 10% and 5%") chart_id="chart-p2pkh-sunset" option=sunset_option/>
