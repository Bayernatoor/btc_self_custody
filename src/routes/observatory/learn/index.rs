...
/// Rendered in declaration order. Data Methodology leads deliberately: it is
/// what someone checking a chart's provenance came here for, and the footer
/// "Learn" link exists to make it reachable in one click.
const ARTICLES: &[Article] = &[
    Article {
        title: "Data Methodology",
        description: "How I detect, count, and measure embedded protocol data. Byte accounting, detection heuristics, confidence levels, known exclusions, and the non-overlapping total formula.",
