                ...
                Some(Ok(_)) => {
                    ...
                    view! {
                        <div class="space-y-10">
                            ...
                            <ChartCard title="Weight Utilization" description=chart_desc(range, "How full each block is, as a percentage of the 4 MWU limit", "Average daily weight utilization as a percentage of the 4 MWU limit") chart_id="chart-weight-util" option=weight_util_option info="The consensus limit is 4,000,000 weight units (4 MWU) per block. Witness data gets a 75% discount, so a block full of SegWit transactions can fit more data than one full of legacy transactions. Consistently high utilization (>90%) means demand for block space is near capacity."/>
