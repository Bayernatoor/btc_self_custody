...

            {
                    ...
                    view! {
                        <div class="space-y-10">
                            ...
                            <ChartCard title="Protocol Fee Competition" description=chart_desc(range, "Fee revenue breakdown: standard transactions vs Ordinals inscriptions vs Runes protocol", "Daily fee revenue by protocol type") chart_id="chart-protocol-fee-competition" option=protocol_fee_option/>
