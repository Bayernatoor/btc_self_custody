    ...
    view! {
        ...
        >
            ...
            <div class="space-y-10">
                ...
                <ChartCard title="UTXO Growth Rate" description=chart_desc(range, "Net UTXO set change per block, counting only outputs that can be spent. Positive means the UTXO set is growing, negative means consolidation", "Daily net UTXO change across all blocks") chart_id="chart-utxo-growth" option=utxo_growth_option/>
