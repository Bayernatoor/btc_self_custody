            ...
            <div id="whale-feed-panel" class="bg-[#0d2137] border border-[#ffd700]/20 rounded-2xl overflow-hidden hidden">
                <div class="flex items-center justify-between px-4 py-2.5 border-b border-[#ffd700]/10">
                    ...
                    <div class="flex items-center gap-1 flex-wrap">
                        ...
                        <button onclick="window._filterNotable('whale')" id="whale-filter-whale" title="Whales: transfer value over $1,000,000 USD (excluding change output)" class="px-2 py-0.5 rounded text-[10px] font-mono bg-transparent border border-white/[0.08] text-[#ffd700]/50 hover:bg-[#ffd700]/10 transition-colors">"Whales"</button>
                        <button onclick="window._filterNotable('round_number')" id="whale-filter-round_number" title="Round-number transfers: exact 1, 10, 100, or 1000 BTC output amounts. Often human-initiated vs exchange automation." class="px-2 py-0.5 rounded text-[10px] font-mono bg-transparent border border-white/[0.08] text-[#90ee90]/60 hover:bg-[#90ee90]/10 transition-colors">"Round #"</button>
                        <button onclick="window._filterNotable('inscription')" id="whale-filter-inscription" title="Large inscriptions: witness data over 100KB (Ordinals, BRC-20, images, JSON)" class="px-2 py-0.5 rounded text-[10px] font-mono bg-transparent border border-white/[0.08] text-[#ff00c8]/50 hover:bg-[#ff00c8]/10 transition-colors">"Inscr."</button>
                        <button onclick="window._filterNotable('consolidation')" id="whale-filter-consolidation" title="Consolidations: 50+ inputs merged into 3 or fewer outputs (exchange cold wallet sweeps, UTXO cleanup)" class="px-2 py-0.5 rounded text-[10px] font-mono bg-transparent border border-white/[0.08] text-[#a855f7]/50 hover:bg-[#a855f7]/10 transition-colors">"Consol."</button>
                        <button onclick="window._filterNotable('fan_out')" id="whale-filter-fan_out" title="Fan-outs: 3 or fewer inputs sprayed to 100+ outputs (exchange batch payouts, mining rewards, airdrops)" class="px-2 py-0.5 rounded text-[10px] font-mono bg-transparent border border-white/[0.08] text-[#00d2ff]/50 hover:bg-[#00d2ff]/10 transition-colors">"Fan-out"</button>
                        <button onclick="window._filterNotable('fee')" id="whale-filter-fee" title="Fee outliers: fee rate over 2000 sat/vB or absolute fee over 0.1 BTC" class="px-2 py-0.5 rounded text-[10px] font-mono bg-transparent border border-white/[0.08] text-[#ff4444]/50 hover:bg-[#ff4444]/10 transition-colors">"Fees"</button>
                        <button onclick="window._filterNotable('op_return')" id="whale-filter-op_return" title="OP_RETURN messages: transactions embedding readable ASCII text on-chain" class="px-2 py-0.5 rounded text-[10px] font-mono bg-transparent border border-white/[0.08] text-[#ffa500]/60 hover:bg-[#ffa500]/10 transition-colors">"Messages"</button>
                    </div>
                </div>
